	...
	public class CubemapGUI : ScriptableObject {
		...
		private void fixInput() {
			...
			if( is2D ) {
				...
				linear = ti.linearTexture;
				compressed = ti.textureFormat != TextureImporterFormat.AutomaticTruecolor && 
		...
		public void renderProbeCallback(object data, bool probeIBL, GameObject selection = null) {
			int faceSize = (int)data;
